...
export const Ventiladores: FansProps[] =
    [
        ...
        //Arno Mesa
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Mesa/VEPX/0.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VEPX/1.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VEPX/2.jpg',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Mesa/VB40/0.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB40/1.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB40/2.jpg',
...

        {
            ...
            descricao: "Deixe os ambientes da sua casa muito mais agradáveis, refrescantes e silenciosos com o novo Ventilador de Mesa desmontável! 4x Mais silencioso e ainda mais forte que os demais disponíveis no mercado Design sofisticado Totalmente desmontável, possibilitando fácil armazenamento Power Zone: uma área concentrada que garante o máximo de vento direcionado, oferecendo performance superior Função Eco Fresh que economiza até 20% de energia ajudando na redução do consumo e nos gastos com a conta de luz. Garantia da marca número 1 e especialista há mais de 60 anos em ventilação",
            imagens: [
                '../src/assets/Ventiladores/Arno/Mesa/VB50/0.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB50/1.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB50/2.jpg',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Mesa/VDBT/0.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VDBT/1.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VDBT/2.jpg',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Mesa/VB55/0.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB55/1.jpg',
                '../src/assets/Ventiladores/Arno/Mesa/VB55/2.jpg',
...

        {
            ...
            descricao: "Deixe os ambientes da sua casa muito mais agradáveis, refrescantes e silenciosos com o novo Ventilador de Mesa desmontável! 4x Mais silencioso e ainda mais forte que os demais disponíveis no mercado Design sofisticado Totalmente desmontável, possibilitando fácil armazenamento Power Zone: uma área concentrada que garante o máximo de vento direcionado, oferecendo performance superior Função Eco Fresh que economiza até 20% de energia ajudando na redução do consumo e nos gastos com a conta de luz. Garantia da marca número 1 e especialista há mais de 60 anos em ventilação",
            imagens: [
                '../src/assets/Ventiladores/Arno/Coluna/VB52/0.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VB52/1.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VB52/2.jpg',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Coluna/VFC4/0.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VFC4/1.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VFC4/2.jpg',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Arno/Coluna/VD5C/0.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VD5C/1.jpg',
                '../src/assets/Ventiladores/Arno/Coluna/VD5C/2.jpg',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Mesa/Protect/0.png',
                '../src/assets/Ventiladores/Britania/Mesa/Protect/1.png',
                '../src/assets/Ventiladores/Britania/Mesa/Protect/2.png',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Mesa/BVT495PA/0.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT495PA/1.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT495PA/2.png',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Mesa/BVT410G/0.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT410G/1.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT410G/2.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT410G/3.png',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Mesa/BVT405/0.png',
                '../src/assets/Ventiladores/Britania/Mesa/BVT405/1.png',
...

        {
            ...
            descricao: "O clima de qualquer ambiente fica muito mais agradável com o Ventilador Britânia Super Turbo BVT405.Sua hélice de 6 pás com diâmetro de 40cm garante um excelente desempenho de ventilação, além do sistema oscilante automático que permite ampla distribuição do ar no ambiente. O Ventilador Britânia conta com 3 velocidades, você escolhe! Mínima, média e máxima.E não para por aí! Seu porta fio e sua alça para transporte garantem fácil manuseio e acondicionamento. Ele pode ser utilizado tanto como ventilador de mesa quanto de chão. Adeque as suas necessidades!Não passe apuros com o calor, desfrute de um ambiente fresquinho com o Ventilador Britânia Super Turbo BVT405!",
            imagens: [
                '../src/assets/Ventiladores/Britania/Coluna/BVC450/0.jpg',
                '../src/assets/Ventiladores/Britania/Coluna/BVC450/1.jpg',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Coluna/BVC680CM/0.jpg',
                '../src/assets/Ventiladores/Britania/Coluna/BVC680CM/1.jpg',
                '../src/assets/Ventiladores/Britania/Coluna/BVC680CM/2.jpg',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Coluna/Turbo30/0.png',
                '../src/assets/Ventiladores/Britania/Coluna/Turbo30/1.png',
                '../src/assets/Ventiladores/Britania/Coluna/Turbo30/2.png',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Britania/Coluna/BVC550P/0.jpg',
                '../src/assets/Ventiladores/Britania/Coluna/BVC550P/1.jpg',
                '../src/assets/Ventiladores/Britania/Coluna/BVC550P/2.jpg',
...

        {
            ...
            descricao: "",
            imagens: [
                '../src/assets/Ventiladores/Mallory/Mesa/AirCareR/0.png',
                '../src/assets/Ventiladores/Mallory/Mesa/AirCareR/1.png',
                '../src/assets/Ventiladores/Mallory/Mesa/AirCareR/2.png',
        ...
        },
        {
            ...
            cor: "Preto  e Laranja",
            imagens: [
                '../src/assets/Ventiladores/Mallory/Mesa/MaxControl/0.png',
                '../src/assets/Ventiladores/Mallory/Mesa/MaxControl/1.png',
                '../src/assets/Ventiladores/Mallory/Mesa/MaxControl/2.png',
                '../src/assets/Ventiladores/Mallory/Mesa/MaxControl/3.png',
...

        {
            ...
            cor: "Preto  e Laranja",
            imagens: [
                '../src/assets/Ventiladores/Mallory/Mesa/Ozonic/0.png',
                '../src/assets/Ventiladores/Mallory/Mesa/Ozonic/1.png',
                '../src/assets/Ventiladores/Mallory/Mesa/Ozonic/2.png',
                '../src/assets/Ventiladores/Mallory/Mesa/Ozonic/3.png',
        ...
        },
        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Mallory/Mesa/NeoAirTS/0.png',
                '../src/assets/Ventiladores/Mallory/Mesa/NeoAirTS/1.png',
                '../src/assets/Ventiladores/Mallory/Mesa/NeoAirTS/2.png',
                '../src/assets/Ventiladores/Mallory/Mesa/NeoAirTS/3.png',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlus/0.png',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlus/1.png',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlus/2.png',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlus/3.png',
            ...
            descricao: "O Ventilador de Coluna NEO AIR Air plus oferece o conforto e a praticidade de seu controle remoto.O único do mercado com exclusiva hélice 15 pás, além da função timer e velocidades para sua comodidade.Com Potência de 140W, grade em sistema especial TS.Possui eficiência energética nas 3 velocidades gerando maior economia.Conta ainda inclinação vertical, grade removível com novos clicks para fácil limpeza.A nova linha de ventiladores Mallory de 40cm oferece grande fluxo de ar, com um funcionamento muito silencioso.",
            imagens: [
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusDourado/0.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusDourado/1.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusDourado/2.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusDourado/3.jpg',
...

        {
            ...
            descricao: "O Ventilador de Coluna NEO AIR Air plus oferece o conforto e a praticidade de seu controle remoto.O único do mercado com exclusiva hélice 15 pás, além da função timer e velocidades para sua comodidade.Com Potência de 140W, grade em sistema especial TS.Possui eficiência energética nas 3 velocidades gerando maior economia.Conta ainda inclinação vertical, grade removível com novos clicks para fácil limpeza.A nova linha de ventiladores Mallory de 40cm oferece grande fluxo de ar, com um funcionamento muito silencioso.",
            imagens: [
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusAzul/0.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusAzul/1.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusAzul/2.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/NeoAirPlusAzul/3.jpg',
...

        {
            ...
            imagens: [
                '../src/assets/Ventiladores/Mallory/Coluna/AirTimerGrafite/0.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/AirTimerGrafite/1.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/AirTimerGrafite/2.jpg',
                '../src/assets/Ventiladores/Mallory/Coluna/AirTimerGrafite/3.jpg',
